...
/**
 *Se define la clase llamada Cajera que implementa la interfaz Runnable
 *Los atributos de cajera son: nombre, compra y tiempoTotalCobro
 */
...
/*
    ...
    */
    public void procesarCompra() {
        System.out.println("Cajera " + nombre + " está procesando la compra de " + compra.cliente);
        ...
        System.out.println("Cajera " + nombre + " ha terminado de procesar la compra de " + compra.cliente);
